...
/*
The Problem:
I need to find the element in the priority queue in O(logn) , How do i do that?
A simple traversal will TLE
*/
...
map<ll,ll> heapi; // To find the heapindex using map in O(logv)
...
void printlist(ll); //Debug function
